...
<div class="page-body pt-6">
    <div class="container-xl">
        <div class="row row-cards">
			...
			<div class="col-12">
				<div class="card card-md p-[2rem] px-[3rem] text-yellow-800 rounded-lg bg-yellow-50 group-[.theme-dark]/body:bg-gray-800 group-[.theme-dark]/body:!text-yellow-300 group-[.theme-dark]/body:border-yellow-800">
					<div class="card-body p-0 text-inherit">
						<div class="row align-items-center">
							...
							<div class="col-12">
								<a class="btn text-white bg-yellow-800 hover:bg-yellow-900 group-[.theme-dark]/body:bg-yellow-300 group-[.theme-dark]/body:!text-gray-800" href="{{ LaravelLocalization::localizeUrl( route('dashboard.user.payment.subscription.payment.cancel') ) }}" onclick="return confirm('This will cancel your subscription immediately and your remaining usages will be removed.');">
									{{__('Cancel My Plan')}}
								</a>
							</div>
						</div>
