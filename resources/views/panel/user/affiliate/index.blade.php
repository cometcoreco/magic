							...
							<div class="row">
								<div class="col-12 col-md-5">
									...
									<div class="flex items-center relative">
										<input id="ref-code" class="form-control h-10 bg-white border-0 group-[.theme-dark]/body:!border-[1px] group-[.theme-dark]/body:!border-solid group-[.theme-dark]/body:!border-[#243049] group-[.theme-dark]/body:!bg-transparent group-[.theme-dark]/body:text-white" type="text" disabled value="{{$setting->site_url}}/register?aff={{\Illuminate\Support\Facades\Auth::user()->affiliate_code}}">
					...
					<div class="card text-heading">
						<div class="card-body flex flex-col py-6 px-8">
                            ...
                            <form id="send_invitation_form" onsubmit="return sendInvitationForm();">
                                <div class="flex items-center relative">
                                    <input class="form-control h-10" type="email" name="to_mail" id="to_mail" placeholder="Email address" required>
