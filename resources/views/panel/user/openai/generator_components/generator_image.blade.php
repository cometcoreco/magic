        ...
        <div class="col-12">
            <div class="card bg-[#F3E2FD] !shadow-sm group-[.theme-dark]/body:bg-[#14171C] group-[.theme-dark]/body:shadow-black">
                <div class="card-body md:p-10">
                    <div class="row">
                        <label for="description" class="h2 mb-3">{{__('Explain your idea')}}. | <a onclick="return fillAnExample();" class="text-success" href="">Fill an Example</a> </label>
                            ...
                            <div class="relative mb-3">
                                ...
                                @foreach(json_decode($openai->questions) as $question)
                                    @if($question->type == 'textarea')
                                        <input class="form-control bg-[#fff] rounded-full h-[53px] text-[#000] !shadow-sm placeholder:text-black image-input-for-fillanexample group-[.theme-dark]/body:placeholder:text-white" type="text" id="{{$question->name}}" name="{{$question->name}}" placeholder="{{$placeholders[array_rand($placeholders)]}}">
                                    @endif
                                @endforeach
