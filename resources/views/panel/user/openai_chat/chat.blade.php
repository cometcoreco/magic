...
@section('content')
	...
	<template id="chat_user_bubble">
		<div class="flex flex-row-reverse content-end mb-2 !text-end lg:ms-auto lg:max-w-[50%] gap-[8px]">
			<span class="text-dark">
				<span class="avatar w-[24px] h-[24px] shrink-0" style="background-image: url(/{{Auth::user()->avatar}})"></span>
			</span>
			<div class="border-none rounded-[2em] mb-[7px] bg-[#F3E2FD] text-[#090A0A] group-[.theme-dark]/body:bg-[rgba(var(--tblr-primary-rgb),0.3)] group-[.theme-dark]/body:text-white">
	...
	<template id="chat_ai_bubble">
		<div class="flex content-start mb-2 lg:max-w-[50%] gap-[8px] group">
			...
			<div class="border-none rounded-[2em] mb-[7px] min-h-[44px] text-[#090A0A] relative before:content-[''] before:rounded-[2em] before:inline-block before:bg-[#E5E7EB] before:absolute before:inset-0 group-[&.loading]:before:animate-pulse-intense group-[.theme-dark]/body:before:bg-[rgba(255,255,255,0.02)] group-[.theme-dark]/body:text-white">
