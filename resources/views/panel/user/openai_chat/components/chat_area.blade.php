...
<div class="flex content-start mb-2 lg:max-w-[50%] gap-[8px]">
	...
	<div class="border-none rounded-[2em] mb-[7px] bg-[#E5E7EB] text-[#090A0A] group-[.theme-dark]/body:bg-[rgba(255,255,255,0.02)] group-[.theme-dark]/body:text-white">
...
<div class="flex content-end mb-2">
	<div class="border w-full-none rounded-[2em] bg-[#F3E2FD] text-[#090A0A] group-[.theme-dark]/body:bg-[rgba(255,255,255,0.02)] group-[.theme-dark]/body:text-white">
		<div class="chat-content py-[0.75rem] px-[1.5rem]">
