    ...
    @foreach ($list as $entry)
		...
		id="chat_{{$entry->id}}">
			...
			<span class="absolute -translate-y-1/2 top-1/2 end-4">
				<button class="chat-item-update-title btn bg-[--tblr-body-bg] w-[28px] h-[28px] p-0 border-[1px] border-solid border-[--tblr-border-color] opacity-0 group-hover:!opacity-100 group-[&.edit-mode]:!opacity-100 group-[&.edit-mode]:!bg-[--tblr-green]  group-[.theme-dark]/body:bg-[rgba(255,255,255,0.08)]">
