						...
						<div class="row">
							...
							<div class="col-md-12">
                                ...
                                <div class="alert alert-info">
                                    ...
                                    <br>Also please note that Chat models works with ChatGPT and GPT-4 models.
                                </div>
							</div>
							...
							<div class="col-md-12">
								<div class="mb-3">
									...
									<select class="form-select" name="openai_default_tone_of_voice" id="opena_default_tone_of_voice">
							...
							<div class="col-md-6">
								<div class="mb-3">
									...
									<input type="number" class="form-control" id="openai_max_input_length" name="opena_max_input_length" min="10" max="1500" value="{{$setting->openai_max_input_length}}" required>
									<span class="block p-2 mt-1 rounded-md text-danger bg-[rgba(var(--tblr-danger-rgb),0.1)]">{{__('In Characters')}}</span>
								</div>
							</div>
							...
							<div class="col-md-6">
								<div class="mb-3">
									...
									<input type="number" class="form-control" id="openai_max_output_length" name="opena_max_output_length" min="0" max="1500" value="{{$setting->openai_max_output_length}}" required>
									<span class="block p-2 mt-1 rounded-md text-danger bg-[rgba(var(--tblr-danger-rgb),0.1)]">{{__('In Words. OpenAI has a hard limit based on Token limits for each model. Refer to OpenAI documentation to learn more. As a recommended by OpenAI, max result length is capped at 1500 words')}}</span>
								</div>
							</div>
