...
@section('title', 'Subscription and Plans')
            ...
            <div class="row g-2 items-center">
                <div class="col">
                    ...
                    <h2 class="page-title mb-2">
                        {{__('Manage Subscription and Pay to Go Plans')}}
                    </h2>
                </div>
            </div>
        </div>
    ...
    <div class="page-body pt-6">
        <div class="container-xl">
            <div class="d-flex mb-3">
                ...
                <a onclick="return toastr.info('This feature is disabled in Demo version.')" class="btn btn-success mx-2">Create New Subscription</a>
                <a onclick="return toastr.info('This feature is disabled in Demo version.')" class="btn btn-primary mx-2">Create New Plan</a>
                @else
                <a href="{{route('dashboard.admin.finance.plans.SubscriptionNewOrEdit')}}" class="btn btn-success mx-2">Create New Subscription</a>
                <a href="{{route('dashboard.admin.finance.plans.PlanNewOrEdit')}}" class="btn btn-primary mx-2">Create New Plan</a>
                @endif
            </div>
            <div class="card">
					...
					<table class="table">
						...
						@foreach($plans as $entry)
							<tr>
								...
								<td class="sort-country">{{$entry->total_words}}</td>
								<td class="sort-status">{{$entry->total_images}}</td>
