...
@section('title', 'Custom Templates Management')
            ...
            <div class="items-center row g-2">
                <div class="col">
                    ...
                    <h2 class="mb-2 page-title">
                        {{__('Openai Custom Template Management')}}
                    </h2>
                </div>
            </div>
        </div>
						...
						@foreach($list as $entry)
							<tr>
								...
								<td class="whitespace-nowrap">
									...
									<a href="{{ LaravelLocalization::localizeUrl( route('dashboard.admin.openai.custom.delete', $entry->id) ) }}" onclick="confirm('{{__('Are you sure? This is permanent.')}}')" class="btn p-0 border w-[36px] h-[36px] hover:bg-red-600 hover:text-white" title="{{__('Delete')}}">
