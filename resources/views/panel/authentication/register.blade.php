			...
			<div class="flex flex-col justify-center col-lg-6">
				<div class="row">
					<div class="mx-auto col-lg-6">
						...
						<div class="container-tight">
							...
							<form novalidate="novalidate" onsubmit="return RegisterForm();">
								...
								<div class="row mt-[35px]">
									<div class="col">
										<button id="RegisterFormButton" class="btn btn-primary w-100">Sign Up</button>
									</div>
								</div>
							</form>
						...
						<div class="row">
							<div class="col-md-12">
								<div class="alert alert-danger">Registration is currently unavailable.</div>
							</div>
						</div>
						@endif
						<div class="mt-20 text-muted">
							Have an account? <a href="{{route('login')}}" tabindex="-1" class="font-medium underline">Log in</a>
						</div>
					</div>
				</div>
			</div>
