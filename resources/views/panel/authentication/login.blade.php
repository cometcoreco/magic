            ...
            <div class="flex flex-col justify-center col-lg-6">
				<div class="row">
					<div class="mx-auto col-lg-6">
						<h1 class="text-center mb-[25px]">Sign in</h1>
						<form novalidate="novalidate" onsubmit="return LoginForm();">
							...
							<div class="row mt-[25px]">
								<div class="col">
									<button id="LoginFormButton" class="btn btn-primary w-100">Sign in</button>
								</div>
							</div>
                            <!-- TODO Openai Demo -->
                            @if(env('APP_STATUS') == 'Demo')
                                <hr class="my-10">
                                <h3 class="card-title text-heading">Test Credentials</h3>
                                <div class="card">
						...
						<div class="mt-3 row gx-2">
							...
							<div class="mb-2 col col-12">
								<a href="{{route('login.github')}}" class="btn w-100">
							...
							<div class="mb-2 col col-12">
								<a href="{{route('login.facebook')}}" class="btn w-100">
						...
						<div class="mt-20 text-center text-muted">
							Don't have account yet? <a href="{{route('register')}}" tabindex="-1" class="font-medium underline">Sign up</a>
						</div>
						@endif
					</div>
                </div>
